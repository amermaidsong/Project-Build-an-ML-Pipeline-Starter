...
def test_row_count(data):
    """
    Check that the dataset has a reasonable number of rows after cleaning
    """
    # Adjust these numbers based on your specific dataset expectations
    assert 15000 < data.shape[0] < 1000000

def test_price_range(data, min_price, max_price):
    """
    Check that the price column is strictly within our config boundaries
    """
